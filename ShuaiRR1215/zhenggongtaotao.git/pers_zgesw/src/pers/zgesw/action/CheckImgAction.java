...
public class CheckImgAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		String words = "ABCDEFGHIJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz23456789";
		// String words =
		...
		// 将生成的字母存入到session中
		ServletActionContext.getRequest().getSession().setAttribute("sessionCode", sb.toString());
